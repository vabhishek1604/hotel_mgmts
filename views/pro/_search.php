...
/* @var $model app\models\ProSearch */
...
<div class="pro-search">
    ...
    <?= $form->field($model, 'commercial_type') ?>

    <?= $form->field($model, 'property_name') ?>

    <?= $form->field($model, 'property_address') ?>

    <?= $form->field($model, 'land_mark') ?>
    ...
    <?php // echo $form->field($model, 'wardnumber_and_name') ?>
    ...
    <?php // echo $form->field($model, 'Price Negotiable') ?>
