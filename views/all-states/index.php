...
/* @var $searchModel app\models\AllStatesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'All States';
$this->params['breadcrumbs'][] = $this->title;
$this->params['menu'][1] = 'allstates';
$this->params['menu'][2] = 'allstates';
?>
<div class="all-states-index">
    <div class="row">
        <div class="col-lg-12">
                                ...
                                'buttons' => [
                                    'all' => function ($url, $model, $key) {
                                        return ButtonDropdown::widget([
                                            ...
                                            'options' => [
                                                'class' => 'btn btn-default btn-sm', 'style' => 'background-color:#cd2820; color:white; margin-top:-5px; margin-left:35px;', // btn-success, btn-info, et cetera
                                            ],
